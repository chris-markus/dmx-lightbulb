...
static const char WEBPAGE_SETTINGS[] PROGMEM =
  "<form method='POST' action='/cmd'>"
    ...
    "<table>"
    "<tr>"
    "<td><label for='alias'>Device Alias: </label></td>"
    "<td><input type='text' name='" CMD_ALIAS_SET_NAME "' value='%s' id='alias'></td>"
    "</tr></table>"
    ...
    "<td><input type='text' name='" CMD_SSID_SET_NAME "' value='%s' id='ssid'></td>"
    "</tr><tr>"
    "<td><label for='passphrase'>Network Passphrase: </label></td>"
    "<td><input type='password' name='" CMD_PASSWORD_SET_NAME "' value='' id='passphrase'></td>"
    "</tr><tr>"
    "<td><label for='mqttBroker'>MQTT Broker: </label></td>"
    "<td><input type='text' name='" CMD_MQTT_BROKER_NAME "' value='%s' id='mqttBroker'></td>"
    "</tr><tr>"
    "<td><label for='mqttUsername'>MQTT Username: </label></td>"
    "<td><input type='text' name='" CMD_MQTT_USERNAME_NAME "' value='%s' id='mqttUsername'></td>"
    "</tr><tr>"
    "<td><label for='mqttPassword'>MQTT Password: </label></td>"
    "<td><input type='password' name='" CMD_MQTT_PASSWORD_NAME "' value='' id='mqttPassword'></td>"
    "</tr><tr>"
    "<td><label for='address'>Address: </label></td>"
    "<td><input type='text' name='" CMD_DMXADDRESS_NAME "' value='%d' id='address'></td>"
    "</tr><tr>"
    "<td><label for='universe'>Universe: </label></td>"
    "<td><input type='text' name='" CMD_DMXUNIVERSE_NAME "' value='%d' id='universe'></td>"
    "</tr></table>"
